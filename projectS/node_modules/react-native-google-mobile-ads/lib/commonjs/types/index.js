...
var _NativeAdRequestOptions = require("./NativeAdRequestOptions");
Object.keys(_NativeAdRequestOptions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _NativeAdRequestOptions[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _NativeAdRequestOptions[key];
    }
  });
});
