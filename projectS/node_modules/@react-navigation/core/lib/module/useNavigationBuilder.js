...
export function useNavigationBuilder(createRouter, options) {
  ...
  const isNestedParamsConsumed = typeof route?.params === 'object' && route.params != null ? consumedParams?.has(route.params) : false;
  const {
    children,
    layout,
    screenOptions,
  ...
  React.useEffect(() => {
    if (consumedParams && didConsumeNestedParams && typeof route?.params === 'object' && route.params != null) {
