...
export type DefaultNavigatorOptions<ParamList extends ParamListBase, NavigatorID extends string | undefined, State extends NavigationState, ScreenOptions extends {}, EventMap extends EventMapBase, Navigation> = DefaultRouterOptions<Keyof<ParamList>> & {
    ...
    layout?: (props: {
        ...
        descriptors: Record<string, Descriptor<ScreenOptions, NavigationProp<ParamList, keyof ParamList, string | undefined, State, ScreenOptions, EventMap>, ScreenRouteProp<ParamList>>>;
        children: React.ReactNode;
    }) => React.ReactElement;
    /**
...
type ScreenRouteProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = Keyof<ParamList>> = {
...
type StaticParamListForConfig<Config> = Config extends StaticNavigationConfig['config'] ? StaticParamList<{
    config: Config;
}> extends infer ParamList extends ParamListBase ? ParamList : ParamListBase : ParamListBase;
type TypedNavigatorStaticComponent<Bag extends NavigatorTypeBagBase, Config> = React.ComponentType<Partial<Omit<Omit<React.ComponentProps<Bag['Navigator']>, keyof DefaultNavigatorOptions<any, any, any, any, any, any>> & DefaultNavigatorOptions<StaticParamListForConfig<Config>, Bag['NavigatorID'], Bag['State'], Bag['ScreenOptions'], Bag['EventMap'], Bag['NavigationList'][keyof Bag['ParamList']]>, 'children'>>>;
